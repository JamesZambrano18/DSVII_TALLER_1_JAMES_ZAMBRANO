...
$miArray = ["Helado","Hamburguesa","Soda"]; // Reemplaza esto con tu propio array
$miString = "Saracatunga"; // Reemplaza esto con tu propio string
$miNumero = 18; // Reemplaza esto con tu propio número
