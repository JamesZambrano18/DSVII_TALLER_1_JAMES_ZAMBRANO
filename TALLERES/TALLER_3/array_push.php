...
$misAmigos = ["Jehan","Emmanuel","Irving"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Oscar", "Carlos"); // Reemplaza las comillas vacías con los nombres de tus amigos
...
array_push($playlist, ["Billie Jean", "Michael Jackson"], ["Like a Rolling Stone", "Bob Dylan"], ["Pockets","Hard life"]);
