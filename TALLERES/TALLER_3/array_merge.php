...
$misComidas = ["Pizza", "Salchipapa", "Papa rellena"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Mac n Cheese", "Tacos de birria", "Huevo Perico"]; // Reemplaza con las comidas favoritas de tu amigo
...
$prueba1= ["a" => "verde", "b" => "azul"];
$prueba2 = ["c" => "verde", "b" => "amarillo", "d" => "rojo"];
$pruebaUnicos = array_unique(array_merge($prueba1, $prueba2));
echo "</br>Colores únicos después de combinar (pruueba):</br>";
print_r($pruebaUnicos);
?>