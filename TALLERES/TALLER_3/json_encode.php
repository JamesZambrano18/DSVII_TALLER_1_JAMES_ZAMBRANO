...
$peliculaFavorita = [
    ...
    "año" => 2023,
    "personajes" => ["Dog Varon", "Robot", "Tin", "Rascal", "Duck"]
];
...
$miplaylist = [
    "Titulo" => "Playlist chida",
    "Colaboradores" => "yo",
    "Canciones" => ["Summer Nights", "Pockets", "Missing love"]
];

$jsonplaylist = json_encode($miplaylist, JSON_PRETTY_PRINT);
echo "<h3>Mi playlist chida</h3>";
echo $jsonplaylist;
