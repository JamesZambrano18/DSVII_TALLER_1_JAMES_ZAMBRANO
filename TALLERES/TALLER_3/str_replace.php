...
$miFrase = "PHP se usa para realizar paginas web, PHP no es tan complicado de aprender, PHP maneja procesos de backend"; // Reemplaza esto con tu frase
...
$buscar = ["Manzanas", "manzanas", "naranjas"];
$reemplazar = ["Peras","peras", "uvas"];
