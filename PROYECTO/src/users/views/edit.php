...
<div class="task-form">
    ...
    <form action="<?= BASE_URL ?>users/update/<?= $user['id'] ?>" method="post">
        ...
        <div>Contraseña</div>
        <div><input type="password" name="pass" value="<?= htmlspecialchars($user['pass']) ?>" required></div>
        <div>Nombre</div>
        ...
        <div>Rol</div>
        <div><input type="text" name="role_id"  value="<?= htmlspecialchars($user['role_id']) ?>" required></div>
